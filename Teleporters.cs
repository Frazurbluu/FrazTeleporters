        ...
        */
        ...
        {    
            ...
            foreach (KeyValuePair<Point4D, Teleport> tele in m_TeleportersD1)
            {
                ...
                {
                    if (!tele.Value.Active) Effects.SendLocationEffect(loc, Map.Maps[tele.Key.M], 11500, 120, 0, 0x26, 3);
                    else Effects.SendLocationEffect(loc, Map.Maps[tele.Key.M], 11500, 75, 1, 1151, 3);
                }
            }
            foreach (KeyValuePair<Point4D, Teleport> tele2 in m_TeleportersD2)
            {
                ...
                {
                    if (!tele2.Value.Active) Effects.SendLocationEffect(loc2, Map.Maps[tele2.Key.M], 11500, 120, 0, 0x26, 3);
                    else Effects.SendLocationEffect(loc2, Map.Maps[tele2.Key.M], 11500, 0, 0, 1151, 3);
                }
            }
